...
## This dir contains many files from original AudioSet VGGish repo, the link: https://github.com/tensorflow/models/tree/master/research/audioset

### To test end-to-end snoring prediction, could try: $ python3 audio_to_prediction.py
__**It would print out snoring prediction of test.wav on two-seconds frames.**__

Also requires downloading two data files:
...
<br>
Below is original VGGish readme.
<br>
---------------------------------------------
---------------------------------------------
